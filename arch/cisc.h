...
#define TRANS(x, res) (((x) == T_VOID) ? snprintf(res, 16, "%s", "T_VOID")     \
  ...
  : ((x) == NOT_DEFINE) ? snprintf(res, 16, "%s", "NOT_DEFINE")                \
  : ((x) == SYMBOL_TABLE) ? snprintf(res, 16, "%s", "SYMBOL_TABLE")            \
  : ((x) == FVAR) ? snprintf(res, 16, "%s", "FVAR")                            \
  : ((x) == FVAR_TABLE) ? snprintf(res, 16, "%s", "FVAR_TABLE")                            \
